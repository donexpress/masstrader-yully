...
function messagePreview(template, ...args) {
  return `Dear customer ${args[0]}:
    ...
    Your order will be shipped within 24 hours and estimated delivery time is 1-3 days. Payment will be made upon delivery (COD), and we accept cash and QR pay. The amount is ${args[3]}.

    Feel free to contact us: service@daynel.com reference ${args[4]}.`;
}
